...
/**
 * Thrown when a {@see \Biscuit\Auth\Rule} cannot be parsed or added to a builder.
 */
class RuleException extends DatalogException
{
    ...
    {
        throw new Error(
            'Biscuit\Exception\RuleException::getParseErrors() should be implemented by the biscuit_php extension.',
        );
    }
    ...
    {
        throw new Error(
            'Biscuit\Exception\RuleException::getMissingParameters() should be implemented by the biscuit_php extension.',
        );
    }
    ...
    {
        throw new Error(
            'Biscuit\Exception\RuleException::getUnusedParameters() should be implemented by the biscuit_php extension.',
        );
    }
}
