...
/**
 * Thrown when a {@see \Biscuit\Auth\Policy} cannot be parsed or added to a builder.
 */
class PolicyException extends DatalogException
{
    ...
    {
        throw new Error(
            'Biscuit\Exception\PolicyException::getParseErrors() should be implemented by the biscuit_php extension.',
        );
    }
    ...
    {
        throw new Error(
            'Biscuit\Exception\PolicyException::getMissingParameters() should be implemented by the biscuit_php extension.',
        );
    }
    ...
    {
        throw new Error(
            'Biscuit\Exception\PolicyException::getUnusedParameters() should be implemented by the biscuit_php extension.',
        );
    }
}
