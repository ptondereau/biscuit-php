...
/**
 * Thrown when a {@see \Biscuit\Auth\Fact} cannot be parsed or added to a builder.
 */
class FactException extends DatalogException
{
    ...
    {
        throw new Error(
            'Biscuit\Exception\FactException::getParseErrors() should be implemented by the biscuit_php extension.',
        );
    }
    ...
    {
        throw new Error(
            'Biscuit\Exception\FactException::getMissingParameters() should be implemented by the biscuit_php extension.',
        );
    }
    ...
    {
        throw new Error(
            'Biscuit\Exception\FactException::getUnusedParameters() should be implemented by the biscuit_php extension.',
        );
    }
}
